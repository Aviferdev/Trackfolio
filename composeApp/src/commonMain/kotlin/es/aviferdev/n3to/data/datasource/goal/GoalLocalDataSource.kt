...
interface GoalLocalDataSource {
    fun getByAccountYear(accountId: String, year: String): Flow<List<MonthlyGoal>>
    fun getByAccountYearMonth(accountId: String, year: String, month: String): Flow<MonthlyGoal?>
    ...
    suspend fun delete(accountId: String, year: String, month: String)

    /** Elimina todos los objetivos de un año (útil antes de guardar batch). */
    suspend fun deleteByAccountYear(accountId: String, year: String)
}
